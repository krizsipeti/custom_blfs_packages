...
grep -qF vscode-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY vscode-version "1.102.3">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF mkvtoolnix-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY mkvtoolnix-version "94.0">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF libvirt-python-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY libvirt-python-version "11.6.0">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF libvirt-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY libvirt-version "11.6.0">' >> ../blfs_root/blfs-xml/packages.ent
