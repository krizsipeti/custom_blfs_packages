...
grep -qF libtorrent-rasterbar-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY libtorrent-rasterbar-version "2.0.13">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF pkcs11-helper-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY pkcs11-helper-version "1.31.0">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF qmplay2-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY qmplay2-version "25.09.11">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF sdl2-image-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY sdl2-image-version "2.8.12">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF libcmark-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY libcmark-version "0.31.2">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF virt-manager-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY virt-manager-version "5.1.0">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF libvirt-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY libvirt-version "12.4.0">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF slirp4netns-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY slirp4netns-version "1.3.4">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF dnsmasq-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY dnsmasq-version "2.93">' >> ../blfs_root/blfs-xml/packages.ent
