...
grep -qF sdl2-image-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY sdl2-image-version "2.8.5">' >> ../blfs_root/blfs-xml/packages.ent
...
grep -qF vscode-version ../blfs_root/blfs-xml/packages.ent || echo '<!ENTITY vscode-version "1.97.2">' >> ../blfs_root/blfs-xml/packages.ent
